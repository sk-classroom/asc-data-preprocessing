...
# %% TODO: Apply the standard scaler to the training data
sc = StandardScaler()
...
# %% TODO: Apply the logistic regression model using scikit-learn without regularization
# - penalty=None # The penalty term is used to prevent overfitting. None means no penalty term
# - solver = "saga"
# - multi_class="ovr"
# - random_state=42
